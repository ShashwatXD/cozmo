...
class SymbolSearch:
    """Resolve symbol queries against a CodeIndex.

    What: name-based symbol lookup with exact, prefix, and fuzzy strategies.
    Why: fast navigation without embedding overhead.
    Layer: search (sits between app and domain).
    """
        ...
        *,
        ...
        for sym in candidates:
            ...
            if name_l.startswith(q) or qname_l.startswith(q):
                # Shorter names = closer prefix match
